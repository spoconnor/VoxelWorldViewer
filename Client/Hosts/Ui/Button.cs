...
namespace Sean.WorldClient.Hosts.Ui
{
    ...
    internal class Button
    {
        ...
        public void Render()
        {
            ...
            if ((HasInventoryValue) || HasKeyBind) //there will be one or both numeric overlays on this button
            {
                GL.BindTexture(TextureTarget.Texture2D, Textures.TextureLoader.CharacterAtlasSmall);

                if (HasInventoryValue) //render overlay inventory value on button
                {
